...
class LLMClient:
    ...
    def log_metric(self, scenario_id: str, call_id: str, endpoint: str, 
                   p_tok: int, c_tok: int, latency: float, status: str, notes: str):
    ...
    def generate(self, prompt: str, system_prompt: str = "", 
                 scenario_id: str = "default", notes: str = "") -> str:
        """
        ...
        try:
            ...
            self.log_metric(
                scenario_id, call_id, endpoint,
                p_tok, c_tok, latency_ms, "SUCCESS", notes
            )
            ...
            self.log_metric(
                scenario_id, call_id, endpoint,
                0, 0, latency_ms, "ERROR", f"{notes} - Error: {str(e)}"
            )
