...
class DatabaseTool:
    ...
    def query_data(self, user_question: str, scenario_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not data_dict:
                return {"status": "success", "answer": "Aucune donnée trouvée.", "chart": None}

            # On demande au LLM comment visualiser ces données
            viz_config = self._recommend_visualization(user_question, columns, data_dict[:5], scenario_id)
    ...
    def _recommend_visualization(self, question: str, columns: List[str], sample_data: List[Dict], scenario_id: str) -> Dict[str, Any]:
        """
        ...
        try:
            resp = self.llm.generate(prompt_viz, scenario_id=scenario_id, notes="DataAnalyst: Viz Config")
    ...
    def _synthesize_answer(self, question: str, results: List, scenario_id: str) -> str:
        ...
        """
        return self.llm.generate(prompt, scenario_id=scenario_id, notes="DataAnalyst: Text Answer")