...
from back.src.core.llm_client import LLMClient
from back.src.tools.vision_tool import VisionTool
from back.src.tools.knowledge_tool import KnowledgeTool
from back.src.tools.database_tool import DatabaseTool
...
class OncologyAgentSystem:
    ...
    def run_pipeline(self, image_path: str, patient_data: Dict[str, Any], status_callback=None) -> Dict[str, Any]:
        """
        ...
        vision_result = self.vision.detect_tumor(
            image_path, 
            self.scenario_id, 
            self.llm
        )
        ...
        is_rejected = "REJETÉ" in critique_result.upper() or "REJECTED" in critique_result.upper()
