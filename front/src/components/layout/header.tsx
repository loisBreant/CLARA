  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-border bg-card px-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-semibold text-foreground">MedVision AI</h1>
          <p className="text-xs text-muted-foreground">Agentic Medical Image Analysis</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 rounded-full bg-accent/20 px-3 py-1.5">
          ...
          <span className="text-sm font-medium text-accent">GPT-4 Vision</span>
        </div>
