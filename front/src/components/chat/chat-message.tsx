...
export function ChatMessage({ message }: ChatMessageProps) {
  ...
  return (
    ...
    >
      <Avatar className={cn("h-9 w-9 shrink-0", isUser ? "bg-secondary" : "bg-primary/20")}>
        <AvatarFallback
          className={cn(isUser ? "bg-secondary text-secondary-foreground" : "bg-primary/20 text-primary")}
        >
